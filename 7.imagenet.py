...
import pickle
import h5py
train_db = h5py.File("hdf5/train_features_DenseNetImageNet.hdf5", "r")
val_db=h5py.File("hdf5/val_features_DenseNetImageNet.hdf5", "r")
...
import pickle
filename = 'DenseNet121ImageNet.pkl'
