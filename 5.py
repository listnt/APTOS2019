...
from keras.applications import DenseNet121, MobileNetV2,ResNet50
...
mobilenet = DenseNet121(weights="imagenet", include_top=False, input_shape=(224, 224, 3))
...
kappa_metrics.my(valdata=(valGen.db["images"][:-1],labels),name="DenseNetModel")
