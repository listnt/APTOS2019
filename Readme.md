| WARNING: Все файлы PKL и файлы моделей пустышки. <br/> Многие скрипты были утеряны, эталонная папка - new_balance_t1t2 |
| --- |
...
**В текущей версии должен был быть Bash файл, к сожалению он утерян**
...
5.py<br/>
данный скрипт запускает процесс обучения CNN
