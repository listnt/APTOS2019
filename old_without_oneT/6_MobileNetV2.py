...
train_dataset=HDF5DatasetWriter((trainGen.db["images"].shape[0],1280),"hdf5/train_features_MobileNetV2.hdf5",dataKey="features",bufSize=1000)
...
val_dataset=HDF5DatasetWriter((valGen.db["images"].shape[0],1280),"hdf5/val_features_MobileNetV2.hdf5",dataKey="features",bufSize=1000)
