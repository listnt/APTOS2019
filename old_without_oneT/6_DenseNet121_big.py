...
train_dataset=HDF5DatasetWriter((trainGen.db["images"].shape[0],49*1024),"hdf5/train_features_DenseNet121_big.hdf5",dataKey="features",bufSize=1000)
...
val_dataset=HDF5DatasetWriter((valGen.db["images"].shape[0],49*1024),"hdf5/val_features_DenseNet121_big.hdf5",dataKey="features",bufSize=1000)
